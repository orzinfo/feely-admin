...
class Role(BaseModel, TimestampMixin):
    ...
    by_role_buttons: fields.ManyToManyRelation[Button] = fields.ManyToManyField(
        "models.Button", related_name="by_button_roles"
    )
...
class Menu(BaseModel, TimestampMixin):
    ...
    by_menu_buttons: fields.ManyToManyRelation[Button] = fields.ManyToManyField(
        "models.Button", related_name="by_button_menus"
    )
...
class Log(BaseModel):
    ...
    by_user: fields.ForeignKeyRelation[User] = fields.ForeignKeyField(
        null=True, model_name="models.User", related_name=None, on_delete=fields.NO_ACTION, description="关联专员"
    )
    api_log: fields.OneToOneRelation[APILog] = fields.OneToOneField(
        "models.APILog", null=True, related_name=None, on_delete=fields.SET_NULL, description="API日志"
    )
