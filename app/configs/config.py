...
validators = [
    ...
    Validator("ADD_LOG_ORIGINS_DECLUDE", default=["/health", "/metrics", "/favicon.ico", "/docs", "/redoc", "/openapi.json"], is_type_of=list, env="default"),
]
...
def get_tortoise_orm_config(engine: Optional[str] = None) -> Dict[str, Any]:
    """
    生成 TortoiseORM 配置
